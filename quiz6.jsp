	 ...
	 <%
            if(request.getParameter("radios") != null) {
                if(request.getParameter("radios").equals("radio1")) {
				 out.println("<p class='error'>You are Wrong!</p><p class='answer'> the answer is document.write()</p>");
...
<br/>
		...
		<FORM ACTION="quiz7.jsp" METHOD="post">
		<div class="question">Question #6: It is a list of "instructions" to be "executed" by the computer.  </div>
		<br/>
