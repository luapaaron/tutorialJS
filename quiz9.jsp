	 ...
	 <%
             if(request.getParameter("radios") != null) {
                if(request.getParameter("radios").equals("radio1")) {
				 out.println("<p class='error'>You are Wrong!</p><p class='answer'> the answer is Multi-line Comments</p>");
...
<br/>
		...
		<FORM ACTION="quiz10.jsp" METHOD="post">
		<div class="question">Question #9: These are containers for storing data values. </div>
		<br/>
