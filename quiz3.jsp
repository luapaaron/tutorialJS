	 ...
	 <%
            if(request.getParameter("radios") != null) {
                if(request.getParameter("radios").equals("radio1")) {
                   out.println("<p class='error'>You are Wrong!</p><p class='answer'> the answer is alert()</p>");
                }
...
<br/>
		...
		<div class="question">Question #3: an form event that fires when the value of the element is changed </div>
		<br/>
