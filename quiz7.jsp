	 ...
	 <%
             if(request.getParameter("radios") != null) {
                if(request.getParameter("radios").equals("radio1")) {
				 out.println("<p class='error'>You are Wrong!</p><p class='answer'> the answer is Computer Program</p>");
...
<br/>
		...
		<FORM ACTION="quiz8.jsp" METHOD="post">
		<div class="question">Question #7: What keyword in JavaScript is use to define variables? </div>
		<br/>
