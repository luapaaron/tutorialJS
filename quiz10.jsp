	 ...
	 <%
             if(request.getParameter("radios") != null) {
                if(request.getParameter("radios").equals("radio1")) {
				 out.println("<p class='error'>You are Wrong!</p><p class='answer'> the answer is JavaScript variables </p>");
...
<br/>
		...
		<FORM ACTION="quizlast.jsp" METHOD="post">
		<div class="question">Question #10:  It is a block of code designed to perform a particular task. </div>
		<br/>
