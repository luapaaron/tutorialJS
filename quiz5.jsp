	 ...
	 <%
            if(request.getParameter("radios") != null) {
                if(request.getParameter("radios").equals("radio1")) {
				 out.println("<p class='error'>You are Wrong!</p><p class='answer'> the answer is 4</p>");
...
<br/>
		...
		<FORM ACTION="quiz6.jsp" METHOD="post">
		<div class="question">Question #5:What is more convenient for testing purposes? </div>
		<br/>
