             ...
             if(request.getParameter("radios") != null) {
                if(request.getParameter("radios").equals("radio1")) {
				 out.println("<p class='correct'>You are correct!</p>");
				  ...
				  out.println("<p class='error'>You are Wrong!</p><p class='answer'> the answer is var</p>");
...
<br/>
		...
		<FORM ACTION="quiz9.jsp" METHOD="post">
		<div class="question">Question #8: Type of comment that starts with /* and ends with */. </div>
		<br/>
